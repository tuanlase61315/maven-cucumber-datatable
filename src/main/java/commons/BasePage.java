...
public class BasePage {
	...
	public String getSelectItemInDropdown(WebDriver driver, String locator, String... values) {
		select = new Select(getElement(driver, getDynamicLocator(locator, values)));
		return select.getFirstSelectedOption().getText();
	}
	...
	public String getAttributeValue(WebDriver driver, String locator, String... values) {
		return getElement(driver, getDynamicLocator(locator, values)).getAttribute("value");
	}
